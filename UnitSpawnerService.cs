namespace CrowbanePackPlugin.Services
{
    internal class UnitSpawnerService
    {
        ...
        private void InitializeUnitLevels()
        {
        ...
        internal Dictionary<long, (float actualDuration, Action<Entity> Actions)> PostActions = new Dictionary<long, (float actualDuration, Action<Entity> Actions)>();
