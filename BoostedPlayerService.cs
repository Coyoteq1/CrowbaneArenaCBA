...
namespace CrowbanePackPlugin.Services
{
	...
	{
		readonly Dictionary<Entity, float> playerAttackSpeed = new Dictionary<Entity, float>();
		readonly Dictionary<Entity, float> playerDamage = new Dictionary<Entity, float>();
		readonly Dictionary<Entity, float> playerHps = new Dictionary<Entity, float>();
		readonly Dictionary<Entity, float> playerSpeeds = new Dictionary<Entity, float>();
		readonly Dictionary<Entity, float> playerYield = new Dictionary<Entity, float>();
		readonly HashSet<Entity> batVisionPlayers = new HashSet<Entity>();
		readonly HashSet<Entity> flyingPlayers = new HashSet<Entity>();
		readonly HashSet<Entity> noAggroPlayers = new HashSet<Entity>();
		readonly HashSet<Entity> noBlooddrainPlayers = new HashSet<Entity>();
		readonly HashSet<Entity> noDurabilityPlayers = new HashSet<Entity>();
		readonly HashSet<Entity> noCooldownPlayers = new HashSet<Entity>();
		readonly HashSet<Entity> immaterialPlayers = new HashSet<Entity>();
		readonly HashSet<Entity> invinciblePlayers = new HashSet<Entity>();
		readonly HashSet<Entity> shroudedPlayers = new HashSet<Entity>();
		readonly HashSet<Entity> sunInvulnPlayers = new HashSet<Entity>();
		readonly HashSet<Entity> daywalkerPlayers = new HashSet<Entity>();
		...
		public void UpdateBoostedPlayer(Entity charEntity)
		{
			...
			if (immaterialPlayers.Contains(charEntity))
			{
				...
				if (BuffUtility.TryGetBuff(Core.EntityManager, charEntity, Prefabs.AB_Blood_BloodRite_Immaterial, out Entity immaterialBuffEntity))
				{
					...
					modifyMovementSpeedBuff.MoveSpeed = 1; 
		...
		public readonly static List<ModifyUnitStatBuff_DOTS> invincibleBuffs = new List<ModifyUnitStatBuff_DOTS>
		{
			PResist,
			FResist,
			HResist,
		...
		public readonly static List<ModifyUnitStatBuff_DOTS> damageBuffs = new List<ModifyUnitStatBuff_DOTS>
		{
			PPower,
			RPower,
			SPPower,
		...
		public readonly static List<ModifyUnitStatBuff_DOTS> speedBuffs = new List<ModifyUnitStatBuff_DOTS>
		{
			Speed,
			ShapeshiftSpeed,
			MountSpeed
