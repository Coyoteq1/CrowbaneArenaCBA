...
internal class PrefabService
{
	...
	internal Dictionary<string, (string Name, PrefabGUID Prefab)> AllNameToGuid { get; init; } = new Dictionary<string, (string Name, PrefabGUID Prefab)>();
	internal Dictionary<string, (string Name, PrefabGUID Prefab)> SpawnableNameToGuid { get; init; } = new Dictionary<string, (string Name, PrefabGUID Prefab)>();
